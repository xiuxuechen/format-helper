...
| Gate | 当前状态 | 说明 |
|---|---|---|
| V5-014 platform-contract-validation | passed | run `28761782614` 已通过，head_sha `83921560685fc3a92ce90bcf993a04b73a3cf7a2`。 |
| V5-014 `win-x64` evidence | passed | run `28761782614` 已通过，artifact digest `sha256:c006455fc6d15452e81a42b4c6d9c2f93a320e5ec87acdfa4082527e50479bb9`。 |
| V5-014 `osx-arm64` evidence | passed | run `28761782614` 已通过，artifact digest `sha256:4d9c0b71f67c62aad9f9d71bdd833f59f7dfbeb3047b90327d03bb1daff473a0`。 |
| aggregate-platform-gate | passed | run `28761782614` 已成功校验两项 win/mac platform evidence。 |
...
| native-toc-evidence CI dedicated runner | skipped_optional | run `28761782614` 为 PR 触发，Word/WPS dedicated runner job 按 `workflow_dispatch` 条件跳过；该路径为后补自动化，不再阻塞已通过本机 Gate 的发布候选。 |
...
| 平台聚合 Gate | ready | run `28761782614` 的 `aggregate-platform-gate` 已通过。 |
...
- run `28761782614` 生成 `win-x64`、`osx-arm64` 两个平台证据，且两者绑定同一 head_sha `83921560685fc3a92ce90bcf993a04b73a3cf7a2`。
