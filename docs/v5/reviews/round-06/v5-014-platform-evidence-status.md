...
最新候选 GitHub Actions run `28761782614` 已通过 `platform-contract-validation`、`win-x64` evidence、`osx-arm64` evidence 与 `aggregate-platform-gate`。由于 Gate 已收敛，当前平台 evidence 不再阻塞 V5-014；不同 head_sha 的 PASS 仍不得混合作为同一发布候选。
...
| runtime_id | 状态 | 证据路径 | 说明 |
|---|---|---|---|
| `win-x64` | passed | `officecli-win-x64-evidence` | GitHub Actions run `28761782614` 上传，artifact digest `sha256:c006455fc6d15452e81a42b4c6d9c2f93a320e5ec87acdfa4082527e50479bb9`。 |
| `osx-arm64` | passed | `officecli-osx-arm64-evidence` | GitHub Actions run `28761782614` 上传，artifact digest `sha256:4d9c0b71f67c62aad9f9d71bdd833f59f7dfbeb3047b90327d03bb1daff473a0`。 |
...
最新候选证据表中的 `win-x64` 与 `osx-arm64` digest 来自 GitHub Actions artifact 元数据，均绑定到 head_sha `83921560685fc3a92ce90bcf993a04b73a3cf7a2`。
...
GitHub Actions run `28761782614` 当前状态：
...
|---|---|---|
| 无 | 无 | 必过平台证据已由 run `28761782614` 生成并通过聚合 Gate；native TOC 已由本机 Word/WPS evidence 覆盖且通过 `native-toc` Gate，dedicated runner 仅作为后补自动化证据。 |
